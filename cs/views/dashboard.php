...
if (!isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Uživatelský panel - Doktor</title>
		<meta charset="utf-8">
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Počet nových návštěv</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-paperclip"></i></span>
									</div>
									<footer class="widget-footer bg-warning">
										<a href="new-appointment.php"><small>Zobrazit podrobnosti</small></a>
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Celkový počet přijatých návštěv</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-ban"></i></span>
									</div>
									<footer class="widget-footer bg-success">
										<a href="approved-appointment.php"><small>Zobrazit podrobnosti</small></a>
										<span class="small-chart pull-right" data-plugin="sparkline"
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										<div class="pull-left">
											...
											<small class="text-color">Počet zrušených návštěv</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-unlock-alt"></i></span>
									</div>
									<footer class="widget-footer bg-danger">
										<a href="cancelled-appointment.php"><small>Zobrazit podrobnosti</small></a>
										<span class="small-chart pull-right" data-plugin="sparkline"
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Počet přijatých návštěv</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
									</div>
									<footer class="widget-footer bg-primary">
										<a href="all-appointment.php"><small>Zobrazit podrobnosti</small></a>
										<span class="small-chart pull-right" data-plugin="sparkline"
