						...
						<div class="col-md-12">
							<div class="widget">
								<header class="widget-header">
									<h4 class="widget-title">Nové návštěvy</h4>
									...
									<div class="table-responsive">
										<table
											...
											<tbody>
												...
												$get_pending_appointment = getAppointmentCount($connection, 0, $doctor_id);
												...
												foreach ($get_pending_appointment as $row) {
													...
													<tr>
														...
														<td><a href="view-appointment-detail.php?aptid=<?php echo urlencode($row['appointment_id']); ?>&&full_name=<?php echo urlencode($full_name); ?>&&p_email=<?php echo $p_email; ?>&&phone=<?php echo urlencode($phone) ; ?>"
