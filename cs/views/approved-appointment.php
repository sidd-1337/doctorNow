...
if (!isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Lékař Ihned - schválené návštěvy</title>
									...
									<div class="table-responsive">
										<table
											...
											<tbody>
												...
												foreach ($get_approved_count as $row) {
													...
													<tr>
														...
														<td><a href="view-appointment-detail.php?aptid=<?php echo htmlentities($row['appointment_id']); 
														?>&&full_name=<?php echo htmlentities($full_name); 
														?>&&p_email=<?php echo htmlentities($p_email); ?>&&phone=<?php echo htmlentities($phone); ?>"
