...
if (!isset($_SESSION['email'])) {
  ...
  <head>
    ...
    <title>Lékař ihned - Pacientův profil</title>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
              <div class="widget">
                <header class="widget-header">
                  <h3 class="widget-title">Pacientův profil</h3>
                ...
                <div class="widget-body">
                  ...
                  <form class="form-horizontal" method="post" action="../controller/doctorAppointmentController.php" name="update-patient-profile">
                    ...
                    <div class="form-group">
                    <label for="email2" class="col-sm-3 control-label">Adresa:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="row">
                    <div class="col-sm-9 col-sm-offset-3">
                      <button type="submit" class="btn btn-success" name="update-patient-profile">Aktualizovat</button>
