...
echo '<script>alert("Heslo bylo úspěšne změněno")</script>';
} else {
echo '<script>alert("Současné zadané heslo je špatně")</script>';
...
<head>
  ...
  <title>Lékař ihned - změna hesla</title>
  <meta charset="utf-8">
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Změna hesla</h3>
          ...
          <div class="widget-body">
            ...
            <form class="form-horizontal" onsubmit="return checkpass();" name="changepassword" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">Současné heslo:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="password" id="password"required='true'>
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Nové heslo:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="newpassword"  class="form-control" required="true">
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Potvrzení nového hesla:</label>
                <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                  <button type="submit" class="btn btn-success" name="submit">Potvrdit změnu</button>
                </div>
              </div>
            </form>
          </div><!-- .widget-body -->
