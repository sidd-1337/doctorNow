              ...
              <ul class="dropdown-menu animated flipInY">
                ...
                <?php if ($_SESSION["type"]=="doctor") {?>
                  <a class="text-color" href="dashboard.php">
                    ...
                    <span>Hlavní uživatelský panel</span>
                  </a>
      ...
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          <?php if ($_SESSION["type"]=="doctor") {?>
            <a href="dashboard.php">
              ...
              <span class="menu-text">Uživatelský panel</span>
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <?php } else {?>
              <span class="menu-text">Návštěvy</span>
              <?php } ?>
              <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
            </a>
            <?php if ($_SESSION["type"]=="doctor") {?>
              <ul class="submenu">
                <li><a href="new-appointment.php"><span class="menu-text">Nové návštěvy</span></a></li>
            <li><a href="approved-appointment.php"><span class="menu-text">Schválené návštěvy</span></a></li>
            <li><a href="cancelled-appointment.php"><span class="menu-text">Zrušené návštěvy</span></a></li>
            <li><a href="all-appointment.php"><span class="menu-text">Všechny návštěvy</span></a></li>
            
          </ul>
          <?php }else if ($_SESSION["type"]=="patient") { ?>
            <ul class="submenu">
              <li><a href="patient-pending-appointment.php"><span class="menu-text">Nevyřízené návštěvy</span></a></li>
              <li><a href="patient-approved-appointment.php"><span class="menu-text">Schválené návštěvy</span></a></li>
              <li><a href="patient-history-appointment.php"><span class="menu-text">Historie návštěvy</span></a></li>
            ...
            <li class="has-submenu">
              <?php if ($_SESSION["type"]=="doctor") {?>
                <a href="../../index.php">
                  ...
                  <span class="menu-text">Domovská stránka</span>
