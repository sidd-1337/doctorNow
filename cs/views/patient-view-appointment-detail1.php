...
if (!isset($_SESSION['email'])) {
  ...
  <head>
    ...
    <title>Návštěva lékaře - Detail návštěv</title>
    <meta charset="utf-8">
                    ...
                    <table border="1" class="table table-bordered mg-b-0">
                      ...
                      <tr>
                        ...
                        <td colspan="4">
                          ...
                          if ($status == 0) {
                            echo "Čeká se na vyřízení";
                          }

                          if ($status == 1) {
                            echo "Vaše návštěva byla schválena";
                          }


                          if ($status == 2) {
                            echo "Vaše návštěva byla zrušena";
                          }
                    ...
                    if ($status == 0) {
                      ...
                      <p align="center" style="padding-top: 20px">
                        <button class="btn btn-danger waves-effect waves-light w-lg" data-toggle="modal"
                          data-target="#myModal">Zrušit návštěvu</button>
                      </p>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title text-danger" id="exampleModalLabel">Opravdu chcete zrušit tuto návštěvu? Tato akce je nenávratná.</h5>
                          </div>
