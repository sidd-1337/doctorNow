...
if (!isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Detail historie návštěv</title>
		<meta charset="utf-8">
						...
						<div class="col-md-12">
							<div class="widget">
								<header class="widget-header">
									<h4 class="widget-title">Lékař Ihned - historie návštěv</h4>
											...
											<tbody>
												...
												foreach ($get_history as $row) {
													...
													<tr>
														...
														?>&&doc_phone=<?php echo htmlentities($doc_phone); ?>&&doc_email=<?php echo htmlentities($doc_email); 
														?>&&address=<?php echo urlencode($address);
														?>&&=<?php echo urlencode($city); ?>"
