...
if (!isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Uživatelský panel - Pacient</title>
		<meta charset="utf-8">
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Nevyřízené návštěvy</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-paperclip"></i></span>
									</div>
									<footer class="widget-footer bg-warning">
										<a href="patient-pending-appointment.php"><small>Zobrazit detail</small></a>
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Schválené návštěvy</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-ban"></i></span>
									</div>
									<footer class="widget-footer bg-success">
										<a href="patient-approved-appointment.php"><small>Zobrazit detail</small></a>
										<span class="small-chart pull-right" data-plugin="sparkline"
								...
								<div class="widget stats-widget">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											<small class="text-color">Historie návštěv</small>
										</div>
										<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
									</div>
									<footer class="widget-footer bg-primary">
										<a href="patient-history-appointment.php"><small>Zobrazit detail</small></a>
										<span class="small-chart pull-right" data-plugin="sparkline"
											data-options="[1,2,3,5,4], { type: 'bar', barColor: '#ffffff', barWidth: 5, barSpacing: 2 }"></span>
									</footer>
								</div><!-- .widget -->
