...
$chngpwd1->execute();
echo "<script>alert('Vaše heslo bylo úspěšně změněno');</script>";
}
else {
echo "<script>alert('Email nebo telefonní číslo jsou neplatné');</script>"; 
}
}
...
<head>
	...
	<title>Lékař Ihned - Zapomenuté heslo</title>
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">Lékař Ihned</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Reset Hesla</h4>
...
<div class="simple-page-footer">
	<p style="color: white">Máte u nás účet? <a href="login.php">Přihlašte se</a></p>
