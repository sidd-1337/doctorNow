                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <select name="status" class="form-control wd-450" required="true">
                                      <option value="1" selected="true">Schválit návštěvu</option>
                                      <option value="2">Zrušit návštěvu</option>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" name="submit_action" class="btn btn-primary">Aktualizovat</button>
