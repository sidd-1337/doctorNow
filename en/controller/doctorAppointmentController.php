...
if (isset($_POST['update-patient-profile'])) {
  ...
  $result = doctorModel::updatePatientProfile($patient_id, $first_name, $last_name, $phone_number, $city, $address, $connection);
  if ($result) {
    $_SESSION['first_name'] = $first_name;
    $_SESSION['last_name'] = $last_name;
    $_SESSION['city'] = $last_name;
...
if (isset($_POST['update-doctor-profile'])) {
  ...
  $result = doctorModel::updateDoctorProfile($doctor_id, $first_name, $last_name, $address, $phone_number, $city, $connection);
  if ($result) {
    $_SESSION['first_name'] = $first_name;
    $_SESSION['last_name'] = $last_name;
    $_SESSION['phone_number'] = $phone_number;
