...
if (!isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Pending Appointment Detail</title>
		<meta charset="utf-8">
						...
						<div class="col-md-12">
							<div class="widget">
								<header class="widget-header">
									<h4 class="widget-title">Pending Appointments</h4>
											...
											<tbody>
												...
												foreach ($get_pending_appointment as $row) {
													...
													<tr>
														...
														<td><a href="patient-view-appointment-detail.php?aptid=<?php echo $row['appointment_id']; 
