                    ...
                    if ($status == 0) {
                      ...
                      <p align="center" style="padding-top: 20px">
                        <button class="btn btn-danger waves-effect waves-light w-lg" data-toggle="modal"
                          data-target="#myModal">Remove Appointment</button>
                      </p>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title text-danger" id="exampleModalLabel">Are you want to delete this
                              appointment?</h5>
                          </div>
                          ...
                          <form method="post" name="delete_appointment_action" action="../controller/doctorAppointmentController.php">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" name="delete_appointment_action" class="btn btn-primary">Yes</button>
