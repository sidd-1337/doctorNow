                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 mx-auto">
                        <div class="doctor_search">
                            ...
                            <h2 class="text-center mb-lg-3 mb-2">Look up your doctor!</h2>
                                ...
                                <div class="col-lg-4"></div>
                                    <div class="col-lg-3 col-6 float-right">
                                        ...
                                        <input id="searchdata" type="text" name="searchdata" class="form-control" placeholder="Search for a doctor">
                                    </div>
                                                            ...
                                                            while ($currentDate <= $endOfWeek) {
                                                                ...
                                                                if (isset($timeSlots[$currentDate])) {
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <form role="form" method="post" name="submit-book" action="en/views/patient-booking-appointment.php">
